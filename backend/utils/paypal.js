 ...
 * @returns {Promise<boolean>} Returns true if it is a new transaction
 * (i.e., the transaction ID does not exist in the database), false otherwise.
 * 
 ...
 * @returns {Promise<Object>} An object with properties 'verified' indicating
 * if the payment is completed and 'value' indicating the payment amount.
 * 
 * @throws {Error} If the request is not successful.
 *
 */
